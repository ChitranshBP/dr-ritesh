...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#understanding" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Fibromyalgia Therapy</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="understanding">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>Fibromyalgia: A Brain-Based Pain Disorder</h2>
                <p class="bi-condition-lead mx-auto">Understanding why fibromyalgia is not "just pain"—it's the brain's pain processing system gone haywire.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="tms-approach">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>How TMS Treats Fibromyalgia</h2>
                <p class="bi-condition-lead mx-auto">Activating the brain's natural pain-suppression systems through targeted magnetic stimulation.</p>
            </div>
    ...
    <div class="bi-condition" id="symptoms">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                ...
                <p class="bi-condition-lead mx-auto">Targeting the central nervous system dysfunction behind every major fibromyalgia symptom.</p>
            </div>
