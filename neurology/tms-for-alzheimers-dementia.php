...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#mci" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Therapy</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="mci">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Mild Cognitive Impairment (MCI)</h2>
                <p class="bi-condition-lead mx-auto">A critical window for intervention: stimulating the brain to reinforce fading memory pathways.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="early-stage">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Early-Stage Alzheimer's</h2>
                <p class="bi-condition-lead mx-auto">Modulating the Default Mode Network (DMN) to preserve independence and cognitive reserve.</p>
            </div>
    ...
    <div class="bi-condition" id="behavioral">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Behavioral &amp; Psychological Symptoms of Dementia (BPSD)</h2>
                <p class="bi-condition-lead mx-auto">Providing relief for the emotional toll of cognitive decline without heavy sedation.</p>
            </div>
