...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#fmd" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Conditions</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="fmd">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Functional Movement Disorder (FMD)</h2>
                <p class="bi-condition-lead mx-auto">A cutting-edge approach to disrupting the abnormal motor patterns created by disrupted brain-body signaling — without medications or surgery.</p>
            </div>
    ...
    <!-- SECTION 2: FND -->
    <div class="bi-condition bg-beige-dark" id="fnd">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Functional Neurological Disorder (FND)</h2>
                <p class="bi-condition-lead mx-auto">When the nervous system generates genuine, disabling symptoms without identifiable structural damage — TMS offers a direct path to neural recalibration.</p>
            </div>
    ...
    <div class="bi-condition" id="psychogenic">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Psychogenic Movement Disorder</h2>
                <p class="bi-condition-lead mx-auto">Resolving abnormal, non-organic movement patterns through precision neuromodulation — targeting the brain, not the label.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="tremor">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Functional Tremor</h2>
                <p class="bi-condition-lead mx-auto">Calming debilitating involuntary trembling with precisely calibrated magnetic pulses — when medications haven't worked.</p>
            </div>
    ...
    <div class="bi-condition" id="dystonia">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Functional Dystonia</h2>
                <p class="bi-condition-lead mx-auto">Releasing abnormal muscle contractions and fixed postures caused by dysfunctional cortical motor control.</p>
            </div>
