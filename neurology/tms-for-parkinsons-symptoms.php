...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <h1 class="text-5xl lg:text-6xl font-serif text-white leading-tight mb-6">
                    TMS for Parkinson's <span class="text-gold-light">&amp; Motor Symptoms</span> in Edison, NJ
                </h1>
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#motor" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Treatment</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="motor">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Motor Rigidity &amp; Bradykinesia</h2>
                <p class="bi-condition-lead mx-auto">Reducing stiffness and improving movement speed by stimulating the supplementary motor area and primary motor cortex.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="tremor">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                ...
                <p class="bi-condition-lead mx-auto">Disrupting the pathological oscillations in the thalamo-cortical loops that drive resting tremors.</p>
            </div>
    ...
    <div class="bi-condition" id="cognitive">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Parkinson's Depression &amp; Cognition</h2>
                <p class="bi-condition-lead mx-auto">Addressing the "non-motor" symptoms of Parkinson's by stimulating the prefrontal cortex.</p>
            </div>
    ...
    <section class="closing-cta py-14 md:py-20 relative overflow-hidden" id="take-action">
        <div class="container mx-auto px-4 max-w-4xl text-center reveal relative z-10">
            ...
            <p class="text-sm text-white/50 mt-6">Also explore <a href="/neurology/tms-for-migraine.php" class="underline hover:text-white">TMS for Migraines</a> and <a href="/neurology/tms-for-stroke-recovery.php" class="underline hover:text-white">TMS for Stroke Recovery</a>.
        </div>
    </section>
