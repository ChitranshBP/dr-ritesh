...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#preventative" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Treatment</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="preventative">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>Preventative TMS for Chronic Migraine</h2>
                <p class="bi-condition-lead mx-auto">Raising the threshold for an attack by stabilizing hyper-reactive cortical networks over time.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="acute">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>TMS for Acute Migraine Rescue</h2>
                <p class="bi-condition-lead mx-auto">Interrupting cortical spreading depression in real-time to abort an incoming attack.</p>
            </div>
    ...
    <div class="bi-condition" id="comorbid">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>Addressing Migraine &amp; Mood Disorders</h2>
                <p class="bi-condition-lead mx-auto">Treating the intertwined networks of chronic pain, depression, and anxiety.</p>
            </div>
