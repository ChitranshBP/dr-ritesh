...
$extra_css  = '    .section-header.center { margin-bottom: 3rem; }
    ...
    .bi-table { width: 100%; border-collapse: separate; border-spacing: 0; margin-top: 0; background: white; border-radius: 1rem; overflow: hidden; box-shadow: 0 4px 15px rgba(11,25,44,0.05); }
    ...
    <div class="container mx-auto px-4 max-w-6xl relative z-10">
        <div class="max-w-3xl mx-auto text-center reveal">
            ...
            <div class="flex flex-wrap justify-center gap-4 mt-10">
                ...
                <a href="#stroke" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Conditions</a>
            </div>
        </div>
    </div>
</section>
...
<div class="bi-condition" id="stroke">
    <div class="container mx-auto px-4 max-w-6xl">
        <div class="reveal text-center">
            <h2>TMS for Post-Stroke Recovery</h2>
            <p class="bi-condition-lead mx-auto">Reviving dormant neural circuits and accelerating neuroplasticity to restore function after ischemic and hemorrhagic strokes.</p>
        </div>
...
<div class="bi-condition bg-beige-dark" id="paralysis">
    <div class="container mx-auto px-4 max-w-6xl">
        <div class="reveal text-center">
            <h2>TMS for Paralysis &amp; Motor Weakness</h2>
            <p class="bi-condition-lead mx-auto">Unlocking residual motor potential and rewiring damaged motor pathways to rebuild strength and coordination.</p>
        </div>
...
<div class="bi-condition" id="aphasia">
    <div class="container mx-auto px-4 max-w-6xl">
        <div class="reveal text-center">
            <h2>TMS for Aphasia &amp; Speech Recovery</h2>
            <p class="bi-condition-lead mx-auto">Restoring the power of communication by reactivating language networks and reducing compensatory speech suppression.</p>
        </div>
        <div class="bi-split reveal" style="grid-template-columns: 1.1fr 0.9fr; align-items: center;">
            <div>
