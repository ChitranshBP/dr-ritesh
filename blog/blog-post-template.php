<?php
/**
 * Blog Post Template — Dr. Ritesh Amin
 *
 * HOW TO CREATE A NEW BLOG POST:
 * 1. Copy this file and rename it (e.g. my-new-post.php)
 * 2. Edit the variables in the block at the top (lines 12-36)
 * 3. Add a matching entry to blog/index.php $posts array
 * 4. Give every <h2> a unique id attribute so it appears in the TOC
 *
 * CONTENT RULES:
 * - Every <h2> MUST have an id: <h2 id="my-section">Heading</h2>
 * - Use <p> for paragraphs, <ul>/<ol> for lists
 * - <blockquote> wraps a <p> for pull-quotes
            ...
            <div class="post-content-wrap">
                ...
                <div class="post-faqs">
                    ...
                    <p class="text-sm text-center mt-8" style="color:var(--color-text-light);">
                        Have more questions?
                        <a href="/contact" class="font-semibold" style="color:var(--color-gold);">Schedule a consultation →</a>
                    </p>
                </div>
