<?php
$page_title = 'TMS Therapy for Treatment-Resistant Depression | Dr. Ritesh Amin – Edison, NJ';
$page_desc  = 'Advanced TMS therapy for Treatment-Resistant Depression (TRD) in Edison, NJ. Offering new hope when multiple medications and therapies have failed.';
...
?>
    ...
    <section class="pt-16 pb-4 bg-white" id="conditions">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="section-header center reveal">
                ...
                <h2 class="section-title">Breaking the Cycle of Failed Meds</h2>
                <p class="section-subtitle">Understanding what makes depression "treatment-resistant" and how neuromodulation bypasses the limitations of oral drugs.</p>
            </div>
            <div class="bi-quicknav reveal" id="condition-tabs">
                <a href="#what-is-trd" class="bi-tab-btn active" data-target="what-is-trd">
                ...
                <a href="#tms-vs-meds" class="bi-tab-btn" data-target="tms-vs-meds">
                ...
                <a href="#treatment-approach" class="bi-tab-btn" data-target="treatment-approach">
    ...
    <!-- SECTION 1: What is TRD? -->
    <div class="bi-condition bi-tab-pane active" id="what-is-trd">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <p class="bi-condition-lead">When traditional oral antidepressants fail to provide adequate relief.</p>
            </div>

            <div class="bi-split reveal" style="grid-template-columns: 1.2fr 0.8fr; align-items: center;">
                <div>
                    <p>Treatment-Resistant Depression (TRD) is generally defined as a major depressive episode that has not responded adequately to at least two different antidepressant trials of adequate dose and duration.</p>
                    <p>Clinical studies, like the STAR*D trial, have shown that with each failed medication trial, the odds of the next medication working decrease significantly, while the likelihood of experiencing intolerable side effects increases. For roughly 30% of depressed patients, oral medications simply will not work.</p>
                    <div class="bi-callout">
                        <p>If you've spent months or years switching from one pill to another without relief, the problem isn't you—it's that you may have a treatment-resistant subtype of depression.</p>
                    </div>
                </div>
                <div class="bi-image-wrapper">
                    <img src="/assets/neurology-tms/depression-brain-activity.png" alt="Brain mapping of treatment resistant depression">
                </div>
            </div>
        </div>
    </div>

    <!-- SECTION 2: TMS vs Meds -->
    <div class="bi-condition bi-tab-pane" id="tms-vs-meds">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                <span class="bi-condition-badge">
                ...
                <p class="bi-condition-lead">Why a physical treatment succeeds when chemical treatments fail.</p>
            </div>
            ...
            <div class="bi-how-grid reveal">
                <div class="bi-how-step">
                    ...
                    <h4>Direct Stimulation</h4>
                    <p>Bypasses the body's systemic metabolism to directly activate the brain's mood centers.</p>
                </div>
                <div class="bi-how-step">
                    <div class="bi-how-num">02</div>
                    <h4>Neuroplastic Growth</h4>
                    <p>Induces the brain to physically rewire itself, creating stronger, healthier pathways.</p>
                </div>
                <div class="bi-how-step">
                    <div class="bi-how-num">03</div>
                    <h4>Durable Relief</h4>
                    <p>Because it addresses the structural component of the network, relief is often long-lasting.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- SECTION 3: Approach -->
    <div class="bi-condition bi-tab-pane" id="treatment-approach">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                <span class="bi-condition-badge">
                ...
                <h2>Advanced Protocols for Boundless Hopel</h2>
                <p class="bi-condition-lead">Dr. Amin utilizes the latest in neuromodulation technology to tackle the hardest-to-treat cases.</p>
            </div>
            ...
            <div class="reveal mt-8">
                <div class="bi-cards-grid">
                    <div class="bi-card">
                        ...
                        <p>We use exact brain mapping techniques tailored to each individual's neuroanatomy for maximum coil efficacy.</p>
                    </div>
                    <div class="bi-card">
                        ...
                        <h4>Dual-Targeting Potential</h4>
                        <p>For patients with severe comorbid anxiety, protocols may be adjusted to stimulate/inhibit multiple targets simultaneously.</p>
                    </div>
                    <div class="bi-card">
    ...
    <section class="py-16 bg-slate-50" id="faq">
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="section-header center reveal mb-8">
                ...
                <h2 class="section-title text-midnight font-serif font-bold">TRD & TMS FAQs</h2>
            </div>
            <div class="bi-faq-accordion reveal delay-1 space-y-3">
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">What exactly defines Treatment-Resistant Depression (TRD)?</h3>
                    ...
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            TRD is generally defined as major depressive disorder that has not responded adequately to at least two different antidepressant medications of adequate dose and duration.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Why does TMS work when medications fail?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            Medications rely on systemic chemical changes that may not cross the blood-brain barrier effectively or target the right receptors. TMS uses magnetic energy to directly physically stimulate dormant brain cells.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Is TMS my last resort for TRD?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            While it is for complex cases, it shouldn't be viewed as a "last resort." It is a highly effective, frontline interventional therapy that many wish they had tried before enduring years of medication trials.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Can I receive Spravato and TMS together?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                ...
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Will I need to stay on medications after TMS?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            Many patients can reduce their medication load, and some may taper off completely under Dr. Amin's supervision. However, some choose to maintain a low-dose medication regimen to support the TMS results.
                        </div>
                    </div>
                </div></div>
        </div>
