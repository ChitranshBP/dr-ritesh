...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#what-is-trd" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Therapy</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="what-is-trd">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>What is Treatment-Resistant Depression?</h2>
                <p class="bi-condition-lead mx-auto">When traditional oral antidepressants fail to provide adequate relief.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="tms-vs-meds">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>A Paradigm Shift in Treatment</h2>
                <p class="bi-condition-lead mx-auto">Why a physical treatment succeeds when chemical treatments fail.</p>
            </div>
    ...
    <!-- SECTION 3: Approach -->
    <div class="bi-condition" id="treatment-approach">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>Advanced Protocols for Boundless Hopel</h2>
                <p class="bi-condition-lead mx-auto">Dr. Amin utilizes the latest in neuromodulation technology to tackle the hardest-to-treat cases.</p>
            </div>
