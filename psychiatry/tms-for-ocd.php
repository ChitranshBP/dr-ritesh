...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#ocd-brain" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Therapy</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- SECTION 1: OCD Brain -->
    <div class="bi-condition" id="ocd-brain">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>The Neurological Circuitry of OCD</h2>
                <p class="bi-condition-lead mx-auto">OCD is a disorder of brain circuitry, not just "anxiety."</p>
            </div>
    ...
    <!-- SECTION 2: Deep TMS -->
    <div class="bi-condition bg-beige-dark" id="deep-tms">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>Reaching the Root with Deep TMS</h2>
                <p class="bi-condition-lead mx-auto">Specialized helmet coils designed to penetrate the cortex and reach the ACC.</p>
            </div>
    ...
    <div class="bi-condition" id="symptoms">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                ...
                <p class="bi-condition-lead mx-auto">Effective across various OCD sub-types.</p>
            </div>
