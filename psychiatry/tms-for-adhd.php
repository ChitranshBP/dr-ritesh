<?php
$page_title = 'TMS Therapy for ADHD | Dr. Ritesh Amin – Edison, NJ';
$page_desc  = 'Innovative neuromodulation for adult ADHD in Edison, NJ. Enhancing focus and executive function without relying solely on stimulants.';
...
?>
    ...
    <section class="py-16 bg-beige-dark/50" id="stats">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="bi-stats-row reveal">
                <div class="bi-stat"><div class="bi-stat-num">Non</div><div class="bi-stat-label">Stimulant Modality</div></div>
                <div class="bi-stat"><div class="bi-stat-num">DLPFC</div><div class="bi-stat-label">Cortical Targeting</div></div>
                <div class="bi-stat"><div class="bi-stat-num">0%</div><div class="bi-stat-label">Cardiovascular Risk</div></div>
                <div class="bi-stat"><div class="bi-stat-num">100%</div><div class="bi-stat-label">Drug Free</div></div>
            </div>
        </div>
    </section>
    ...
    <section class="pt-16 pb-4 bg-white" id="conditions">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="section-header center reveal">
                ...
                <h2 class="section-title">Activating the Executive Network</h2>
                <p class="section-subtitle">How specific magnetic frequencies can stimulate the sluggish areas of the brain responsible for focus and task completion.</p>
            </div>
            <div class="bi-quicknav reveal" id="condition-tabs">
                <a href="#adhd-brain" class="bi-tab-btn active" data-target="adhd-brain">
                ...
                <a href="#how-tms-works" class="bi-tab-btn" data-target="how-tms-works">
    ...
    <!-- SECTION 1: ADHD Brain -->
    <div class="bi-condition bi-tab-pane active" id="adhd-brain">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <h2>The Neurological Basis of ADHD</h2>
                <p class="bi-condition-lead">ADHD is characterized by underactivity in the brain's executive control centers.</p>
            </div>

            <div class="bi-split reveal" style="grid-template-columns: 1.2fr 0.8fr; align-items: center;">
                <div>
                    <p>Attention-Deficit/Hyperactivity Disorder (ADHD) is heavily linked to structural and functional variations in the prefrontal cortex—the part of the brain that acts as the "CEO." This area governs executive functions: impulse control, sustained attention, working memory, and organization.</p>
                    <p>In the ADHD brain, imaging often shows that the prefrontal cortex is electrically under-aroused. Because the "brakes" (executive control) are sluggish, the brain struggles to filter out distractions and maintain focus on unstimulating tasks. This is why stimulant medications (like Adderall or Ritalin) are used—to artificially "wake up" the prefrontal cortex.</p>
                    <div class="bi-callout">
                        <p>While effective for some, stimulants carry substantial risks including cardiovascular stress, insomnia, anxiety exacerbation, and chemical dependence.</p>
                    </div>
                </div>
                <div class="bi-image-wrapper">
                    <img src="/assets/neurology-tms/depression-brain-activity.png" alt="Brain mapping of ADHD">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bi-condition bi-tab-pane" id="how-tms-works">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                <span class="bi-condition-badge">
                ...
                <h2>Activating the Prefrontal Cortex</h2>
                <p class="bi-condition-lead">A localized, magnetic approach to achieving neuro-arousal.</p>
            </div>

            <div class="bi-split reveal" style="grid-template-columns: 0.8fr 1.2fr; align-items: center;">
                <div class="bi-image-wrapper">
                    <img src="/assets/neurology-tms/tms-device-patient.png" alt="Patient receiving TMS therapy for ADHD">
                </div>
                <div>
                    <p>TMS (Transcranial Magnetic Stimulation) offers a way to stimulate the sluggish prefrontal cortex directly, without flooding the entire body with stimulant amphetamines. By applying high-frequency magnetic pulses specifically to the right dorsolateral prefrontal cortex (DLPFC), TMS forces these neurons to fire more actively.</p>
                    <p>Over a course of treatment, this repeated stimulation encourages neuroplasticity within the executive network. The brain learns to maintain a higher baseline of cortical arousal, leading to improved natural focus and better impulse control long after the sessions end.</p>
                </div>
            </div>
            ...
            <div class="bi-how-grid reveal">
                <div class="bi-how-step">
                    ...
                    <h4>Targeted Arousal</h4>
                    <p>Direct magnetic stimulation of the executive centers to 'wake up' sluggish cognitive pathways.</p>
                </div>
                <div class="bi-how-step">
                    <div class="bi-how-num">02</div>
                    <h4>Network Strengthening</h4>
                    <p>Repeated sessions foster neuroplasticity, building stronger, faster connections for sustained attention.</p>
                </div>
                <div class="bi-how-step">
                    <div class="bi-how-num">03</div>
                    <h4>Dual-Benefit</h4>
                    <p>Often, ADHD co-occurs with depression. TMS can be mapped to treat both the depressive symptoms and the cognitive deficits simultaneously.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bi-condition bi-tab-pane" id="symptoms">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <h2>Cognitive Symptoms Improved by TMS</h2>
                <p class="bi-condition-lead">Enhancing adult executive function for better daily performance.</p>
            </div>
            ...
            <div class="reveal mt-8">
                <div class="bi-cards-grid">
                    <div class="bi-card">
                        ...
                        <p>Improving the ability to maintain focus on complex, unstimulating tasks (like reading or paperwork) without constant distraction.</p>
                    </div>
                    <div class="bi-card">
                        ...
                        <p>Enhancing short-term recall and the mental 'workspace' required to juggle multi-step instructions and daily planning.</p>
                    </div>
                    <div class="bi-card">
                        ...
                        <p>Reducing chronic procrastination and the overwhelming executive dysfunction that prevents simply 'getting started.'</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 bg-white" id="approach">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="section-header center reveal mb-8">
                ...
                <h2 class="section-title text-midnight font-serif font-bold">Why the Shift Away from Stimulants?</h2>
                <p class="section-subtitle">A vital option for adults who cannot tolerate amphetamine-based medications.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 reveal delay-1">
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-midnight mb-3 font-serif">Heart Health</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">Adults with cardiovascular issues, high blood pressure, or a history of heart disease often absolutely cannot take stimulant ADHD medications. TMS presents zero cardiovascular risk.</p>
                </div>
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <div class="w-12 h-12 bg-gold/10 rounded-2xl flex items-center justify-center text-gold mb-5">
                    ...
                    <h3 class="text-xl font-bold text-midnight mb-3 font-serif">Prevents the 'Crash'</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">Medications provide focus for 8 hours followed by a severe mood and energy crash. TMS works by fundamentally altering the baseline neural tone, providing a smooth, 24/7 improvement in functioning.</p>
                </div>
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <div class="w-12 h-12 bg-gold/10 rounded-2xl flex items-center justify-center text-gold mb-5">
    ...
    <section class="py-16 bg-slate-50" id="faq">
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="section-header center reveal mb-8">
                ...
                <h2 class="section-title text-midnight font-serif font-bold">TMS for ADHD FAQs</h2>
            </div>
            <div class="bi-faq-accordion reveal delay-1 space-y-3">
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">How does TMS help with ADHD symptoms?</h3>
                    ...
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            TMS helps with ADHD by targeting and stimulating the prefrontal cortex, the area of the brain responsible for executive functions, attention, and impulse control, which is often underactive in individuals with ADHD.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Is TMS for ADHD a replacement for stimulants like Adderall?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            TMS can be an excellent alternative or adjunct therapy for individuals who do not tolerate stimulant medications well, experience severe side effects, or prefer a non-pharmacological approach to managing their ADHD.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">How many TMS sessions are needed for ADHD?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            A typical course of TMS for ADHD involves 30 to 36 sessions, usually administered 5 days a week for about 6 weeks, similar to standard TMS protocols.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Are the effects of TMS for ADHD permanent?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            Many patients experience long-lasting improvements in focus and executive function. However, ADHD is a chronic condition, and some patients may benefit from maintenance sessions in the future.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Is TMS safe for adults with ADHD?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            Yes, TMS is a safe, FDA-cleared, non-invasive procedure with very few side effects. The most common side effect is mild scalp discomfort during the session, which typically resolves quickly.
                        </div>
                    </div>
                </div></div>
        </div>
    ...
    <section class="closing-cta py-16 lg:py-20 relative overflow-hidden" id="take-action">
        <div class="container mx-auto px-4 max-w-4xl text-center reveal relative z-10">
            <span class="block text-sm font-semibold tracking-widest text-gold uppercase mb-3">Reclaim Your Focus</span>
