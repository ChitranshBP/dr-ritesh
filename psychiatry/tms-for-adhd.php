...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#adhd-brain" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Therapy</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="adhd-brain">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>The Neurological Basis of ADHD</h2>
                <p class="bi-condition-lead mx-auto">ADHD is characterized by underactivity in the brain's executive control centers.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="how-tms-works">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>Activating the Prefrontal Cortex</h2>
                <p class="bi-condition-lead mx-auto">A localized, magnetic approach to achieving neuro-arousal.</p>
            </div>
    ...
    <div class="bi-condition" id="symptoms">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                ...
                <p class="bi-condition-lead mx-auto">Enhancing adult executive function for better daily performance.</p>
            </div>
