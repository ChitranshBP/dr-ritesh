...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#bipolar-brain" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Therapy</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="bipolar-brain">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>The Complexity of Bipolar Depression</h2>
                <p class="bi-condition-lead mx-auto">A fundamentally different neurological landscape than standard Major Depressive Disorder.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="tms-safety">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>A Controlled Ascent</h2>
                <p class="bi-condition-lead mx-auto">Why physical modulation is safer than systemic chemical flooding.</p>
            </div>
    ...
    <div class="bi-condition" id="symptoms">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                ...
                <p class="bi-condition-lead mx-auto">Targeting the unique presentation of the bipolar 'low'.</p>
            </div>
