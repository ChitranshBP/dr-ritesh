<?php
$page_title = 'TMS Therapy for Panic Disorder | Dr. Ritesh Amin – Edison, NJ';
$page_desc  = 'Advanced TMS therapy to treat Panic Disorder and severe anxiety in Edison, NJ. Regain control over debilitating panic attacks without heavy sedatives.';
...
?>
    ...
    <section class="pt-16 pb-4 bg-white" id="conditions">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="section-header center reveal">
                ...
                <h2 class="section-title">De-escalating the False Alarm</h2>
                <p class="section-subtitle">How specific magnetic frequencies can teach an overly reactive nervous system to stay grounded.</p>
            </div>
            <div class="bi-quicknav reveal" id="condition-tabs">
                <a href="#panic-brain" class="bi-tab-btn active" data-target="panic-brain">
    ...
    <!-- SECTION 1: Panic Brain -->
    <div class="bi-condition bi-tab-pane active" id="panic-brain">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <h2>The Neurological Spark of Panic</h2>
                <p class="bi-condition-lead">A panic attack is a physical misfiring of the brain's survival machinery.</p>
            </div>

            <div class="bi-split reveal" style="grid-template-columns: 1.2fr 0.8fr; align-items: center;">
                <div>
                    <p>Panic Disorder occurs when the brain's fight-or-flight response activates suddenly and intensely, without any actual danger present. In neuroimaging studies of patients with Panic Disorder, researchers repeatedly see hyperactivity in the amygdala and right prefrontal cortex.</p>
                    <p>When these regions become highly sensitized, even minor physiological changes (like a slightly elevated heart rate) can trigger a cascading, overwhelming neuro-electric response that feels entirely like an impending catastrophe.</p>
                    <div class="bi-callout">
                        <p>Because panic is often deeply physiological, cognitive attempts to "talk yourself out of it" frequently fail. The structural sensitivity of the brain must be addressed.</p>
                    </div>
                </div>
                <div class="bi-image-wrapper">
                    <img src="/assets/neurology-tms/depression-brain-activity.png" alt="Brain mapping of anxiety and panic">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bi-condition bi-tab-pane" id="how-tms-works">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <h2>Slowing the Misfire</h2>
                <p class="bi-condition-lead">Utilizing inhibitory magnetic frequencies to desensitize the panic response.</p>
            </div>
            ...
            <div class="bi-how-grid reveal">
                <div class="bi-how-step">
                    ...
                    <h4>Inhibitory Stimulation</h4>
                    <p>Slow magnetic pulses act to suppress the over-excitability of the right cortical regions.</p>
                </div>
                <div class="bi-how-step">
                    <div class="bi-how-num">02</div>
                    <h4>Raising the Threshold</h4>
                    <p>As neuroplasticity occurs, the brain literally becomes less "twitchy" and reactive to minor stimuli.</p>
                </div>
                <div class="bi-how-step">
                    <div class="bi-how-num">03</div>
                    <h4>Reduced Anticipatory Fear</h4>
                    <p>With fewer spontaneous attacks, the underlying dread of "when will the next one happen" begins to dissipate.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bi-condition bi-tab-pane" id="symptoms">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <h2>Symptoms Relieved by Neuromodulation</h2>
                <p class="bi-condition-lead">Addressing both the acute attacks and the chronic dread.</p>
            </div>
            ...
            <div class="reveal mt-8">
                <div class="bi-cards-grid">
                    <div class="bi-card">
                        ...
                        <h4>Spontaneous Panic Attacks</h4>
                        <p>Reducing the frequency and severe intensity of sudden, out-of-the-blue panic episodes and physical symptoms (heart palpitations, shortness of breath).</p>
                    </div>
                    <div class="bi-card">
                        ...
                        <h4>Anticipatory Anxiety</h4>
                        <p>Calming the persistent, exhausting fear and worry about having another panic attack in the future.</p>
                    </div>
                    <div class="bi-card">
                        ...
                        <h4>Agoraphobia</h4>
                        <p>By preventing the attacks, patients regain the neurological confidence required to stop avoiding public or crowded triggering spaces.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 bg-white" id="approach">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="section-header center reveal mb-8">
                ...
                <h2 class="section-title text-midnight font-serif font-bold">Why Avoid the Benzodiazepine Trap?</h2>
                <p class="section-subtitle">TMS offers a path to permanent relief without chemical dependency.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 reveal delay-1">
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-midnight mb-3 font-serif">Zero Addiction Risk</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">Common treatments for panic (like Xanax or Klonopin) are highly addictive. TMS carries absolutely zero risk of chemical dependency or dangerous withdrawal.</p>
                </div>
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <div class="w-12 h-12 bg-gold/10 rounded-2xl flex items-center justify-center text-gold mb-5">
                    ...
                    <h3 class="text-xl font-bold text-midnight mb-3 font-serif">Structural Change</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">While anti-anxiety pills simply mask the symptoms while they are in your bloodstream, TMS promotes neuroplasticity, actually healing the dysfunctional circuitry for durable relief.</p>
                </div>
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <div class="w-12 h-12 bg-gold/10 rounded-2xl flex items-center justify-center text-gold mb-5">
                    ...
                    <h3 class="text-xl font-bold text-midnight mb-3 font-serif">No Cognitive Fog</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">Panic medications are sedatives that dull your reactions and memory. TMS leaves your cognition intact, allowing you to return immediately to work or driving post-session.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-slate-50" id="faq">
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="section-header center reveal mb-8">
                ...
                <h2 class="section-title text-midnight font-serif font-bold">TMS for Panic FAQs</h2>
            </div>
    ...
    <section class="closing-cta py-16 lg:py-20 relative overflow-hidden" id="take-action">
        <div class="container mx-auto px-4 max-w-4xl text-center reveal relative z-10">
            <span class="block text-sm font-semibold tracking-widest text-gold uppercase mb-3">Reclaim Your Freedom</span>
