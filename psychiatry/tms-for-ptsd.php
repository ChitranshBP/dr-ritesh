<?php
$page_title = 'TMS Therapy for PTSD | Dr. Ritesh Amin – Edison, NJ';
$page_desc  = 'Innovative TMS therapy for Post-Traumatic Stress Disorder (PTSD) in Edison, NJ. Helping patients process trauma and reclaim control of their lives.';
...
?>
    ...
    <section class="pt-16 pb-4 bg-white" id="conditions">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="section-header center reveal">
                ...
                <h2 class="section-title">Rewiring the Trauma Response</h2>
                <p class="section-subtitle">How exact magnetic stimulation can break the neurological looping of fear and panic.</p>
            </div>
            <div class="bi-quicknav reveal" id="condition-tabs">
                <a href="#ptsd-brain" class="bi-tab-btn active" data-target="ptsd-brain">
    ...
    <!-- SECTION 1: PTSD Brain -->
    <div class="bi-condition bi-tab-pane active" id="ptsd-brain">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <h2>The Neurological Impact of Trauma</h2>
                <p class="bi-condition-lead">PTSD is an acquired, physical injury to the brain's fear-processing circuitry.</p>
            </div>

            <div class="bi-split reveal" style="grid-template-columns: 1.2fr 0.8fr; align-items: center;">
                <div>
                    <p>Post-Traumatic Stress Disorder alters the physical structure and functional connectivity of the brain. When trauma occurs, the amygdala (fear center) becomes hyper-reactive, while the ventromedial prefrontal cortex (the area responsible for regulating the amygdala and recognizing safety) becomes suppressed.</p>
                    <p>This communication breakdown traps the brain in a perpetual state of threat detection. This is why individuals with PTSD may react to non-threatening stimuli as if they are life-threatening, and why cognitive therapy alone is sometimes insufficient—the biological alarm system must be reset.</p>
                    <div class="bi-callout">
                        <p>TMS addresses the physical hardware of the brain, giving talk therapy and processing techniques a healthier space to take root.</p>
                    </div>
                </div>
                <div class="bi-image-wrapper">
                    <img src="/assets/psychiatry-tms/ptsd-brain.png" alt="Brain mapping of PTSD">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bi-condition bi-tab-pane" id="how-it-works">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <h2>Resetting the Alarm</h2>
                <p class="bi-condition-lead">Using targeted magnetic stimulation to restore communication between the prefrontal cortex and amygdala.</p>
            </div>

            <div class="bi-split reveal" style="grid-template-columns: 0.8fr 1.2fr; align-items: center;">
                <div class="bi-image-wrapper">
                    <img src="/assets/psychiatry-tms/ptsd-recovery.png" alt="Patient receiving TMS therapy">
                </div>
                <div>
                    <p>By delivering specific magnetic pulses to the prefrontal cortex, TMS strengthens the neural pathways responsible for "top-down" emotional regulation. As neuroplasticity occurs, the prefrontal cortex regains its ability to down-regulate the hyperactive amygdala.</p>
                    <p>Additionally, TMS can be applied using inhibitory frequencies the right side of the brain to directly dampen the overactive fear response, making patients feel physically safer in their bodies.</p>
                </div>
            </div>
            ...
            <div class="bi-how-grid reveal">
                <div class="bi-how-step">
                    ...
                    <p>Enhancing the "executive" areas of the brain to regain control over emotional flooding.</p>
                </div>
                <div class="bi-how-step">
                    <div class="bi-how-num">02</div>
                    <h4>Fear Dampening</h4>
                    <p>Down-modulating the deep brain structures stuck in perpetual "fight or flight."</p>
                </div>
                <div class="bi-how-step">
                    <div class="bi-how-num">03</div>
                    <h4>Trauma Processing</h4>
                    <p>Creating a calmer neural baseline enables patients to process trauma more effectively in therapy.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bi-condition bi-tab-pane" id="symptoms">
        <div class="container mx-auto px-4 max-w-5xl">
            <div class="reveal">
                ...
                <h2>PTSD Symptoms Targeted by TMS</h2>
                <p class="bi-condition-lead">Addressing the core experiential clusters of the disorder.</p>
            </div>
            ...
            <div class="reveal mt-8">
                <div class="bi-cards-grid">
                    <div class="bi-card">
                        ...
                        <h4>Hyperarousal</h4>
                        <p>Reducing startle responses, chronic edginess, irritability, and the inability to relax in safe environments.</p>
                    </div>
                    <div class="bi-card">
                        ...
                        <p>Helping to disconnect the overwhelming emotional distress tied to intrusive thoughts and flashbacks.</p>
                    </div>
                    <div class="bi-card">
                        ...
                        <h4>Avoidance & Numbing</h4>
                        <p>Alleviating the depressive-like symptoms of emotional bluntness and total avoidance of triggering stimuli.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 bg-white" id="approach">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="section-header center reveal mb-8">
                ...
                <h2 class="section-title text-midnight font-serif font-bold">Why Consider TMS for PTSD?</h2>
                <p class="section-subtitle">A physiological approach to a disorder that medications struggle to reach.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 reveal delay-1">
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-midnight mb-3 font-serif">Limits Chemical Reliance</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">PTSD is incredibly complex to treat with single medications. TMS offers a powerful tool that doesn\'t require adding another pill to an existing regimen.</p>
                </div>
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <div class="w-12 h-12 bg-gold/10 rounded-2xl flex items-center justify-center text-gold mb-5">
                    ...
                    <h3 class="text-xl font-bold text-midnight mb-3 font-serif">Passive Treatment</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">TMS does not require a patient to actively relive trauma during the magnetic therapy. You simply recline and let the stimulation work.</p>
                </div>
                <div class="bg-slate-50 border border-slate-100 p-8 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <div class="w-12 h-12 bg-gold/10 rounded-2xl flex items-center justify-center text-gold mb-5">
    ...
    <section class="py-16 bg-slate-50" id="faq">
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="section-header center reveal mb-8">
                ...
                <h2 class="section-title text-midnight font-serif font-bold">TMS for PTSD FAQs</h2>
            </div>
            <div class="bi-faq-accordion reveal delay-1 space-y-3">
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">What specific PTSD symptoms does TMS treat?</h3>
                    ...
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            TMS helps alleviate intrusive thoughts, hyperarousal, severe anxiety, and the emotional numbness associated with Post-Traumatic Stress Disorder by modulating fear-processing centers.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">How does TMS &quot;re-wire&quot; the traumatized brain?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            Trauma causes the amygdala to become hyper-reactive. TMS stimulates the prefrontal cortex to strengthen its regulatory control over the amygdala, helping to dampen exaggerated fear responses.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Is TMS for PTSD painful?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            No, the procedure is non-invasive and painless. You may feel a slight tapping sensation on the scalp, but it is well-tolerated by patients with severe trauma histories.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">Can I continue trauma therapy (like EMDR) during TMS?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            Absolutely. In fact, combining TMS with trauma-focused therapies like EMDR or CBT often enhances the effectiveness of both, as TMS primes the brain for learning and neuroplasticity.
                        </div>
                    </div>
                </div>
                <div class="bi-faq-item bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-gold/50 transition-colors">
                    <button class="bi-faq-header w-full flex items-center justify-between p-6 text-left cursor-pointer focus:outline-none">
                        <h3 class="text-lg font-bold text-midnight font-serif">How many treatments will I need for PTSD?</h3>
                        <span class="bi-faq-icon text-gold ml-4 shrink-0 transition-transform duration-300">
                            <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                        </span>
                    </button>
                    <div class="bi-faq-content max-h-0 overflow-hidden transition-all duration-300 ease-in-out opacity-0">
                        <div class="p-6 pt-0 text-gray-600 leading-relaxed">
                            A standard protocol involves 30 to 36 sessions over about 6 weeks, though Dr. Amin will customize the duration based on your specific symptom severity and response.
                        </div>
                    </div>
                </div></div>
        </div>
    ...
    <section class="closing-cta py-16 lg:py-20 relative overflow-hidden" id="take-action">
        <div class="container mx-auto px-4 max-w-4xl text-center reveal relative z-10">
            <span class="block text-sm font-semibold tracking-widest text-gold uppercase mb-3">Reclaim Your Present</span>
