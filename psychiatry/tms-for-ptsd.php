...
?>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <a href="#ptsd-brain" class="btn btn-ghost !border-white/20 !text-white hover:!border-white hover:!bg-white hover:!text-midnight transition-all">Explore Therapy</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="bi-condition" id="ptsd-brain">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>The Neurological Impact of Trauma</h2>
                <p class="bi-condition-lead mx-auto">PTSD is an acquired, physical injury to the brain's fear-processing circuitry.</p>
            </div>
    ...
    <div class="bi-condition bg-beige-dark" id="how-it-works">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                <h2>Resetting the Alarm</h2>
                <p class="bi-condition-lead mx-auto">Using targeted magnetic stimulation to restore communication between the prefrontal cortex and amygdala.</p>
            </div>
    ...
    <div class="bi-condition" id="symptoms">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="reveal text-center">
                ...
                <p class="bi-condition-lead mx-auto">Addressing the core experiential clusters of the disorder.</p>
            </div>
