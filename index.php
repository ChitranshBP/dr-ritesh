                ...
                <div class="hero-content reveal">
                    ...
                    <div class="hero-actions">
                        ...
                        <a href="#tms-therapy" class="btn btn-ghost">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M10 8l6 4-6 4V8z"/></svg>
                            Explore TMS
                        </a>
                    </div>
            ...
            <div class="silo-container">
                ...
                <div class="silo-block reveal">
                    ...
                    <div class="silo-chips">
                        ...
                        <a href="/psychiatry/tms-for-panic-disorder.php" class="condition-chip"><span class="chip-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></span>Panic Disorder <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg></a>
                ...
                <div class="silo-block reveal delay-1">
                    ...
                    <div class="silo-chips">
                        ...
                        <a href="/neurology/tms-for-fibromyalgia.php" class="condition-chip"><span class="chip-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg></span>Fibromyalgia <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg></a>
                        <!-- DNA helix — represents genetic/hereditary neurodegenerative condition -->
                        <a href="/neurology/tms-for-huntingtons-disease.php" class="condition-chip"><span class="chip-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 15c6.667-6 13.333 0 20-6"/><path d="M9 22c1.798-1.998 2.518-3.995 2.807-5.993"/><path d="M15 2c-1.798 1.998-2.518 3.995-2.807 5.993"/><path d="M17 6l-2.5 2.5"/><path d="M14 8.5l-2.5 2.5"/><path d="M7 18l2.5-2.5"/><path d="M9.5 15.5l2.5-2.5"/></svg></span>Huntington's Disease <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg></a>
                        <!-- Heart pulse — represents vascular/arterial condition -->
                        <a href="/neurology/tms-for-fibromuscular-dysplasia.php" class="condition-chip"><span class="chip-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></span>Fibromuscular Dysplasia <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="journey-section bg-beige-dark" id="patient-journey">
        <div class="container">
            <div class="section-header center reveal">
                ...
                <p class="section-subtitle">A straightforward, transparent process designed to get you on the road to recovery as quickly as possible.</p>
            </div>
            <div class="journey-steps-grid">
                <div class="journey-step-card reveal">
                    ...
                    <p>Discuss your symptoms, medical history, and treatment goals with Dr. Amin to determine if TMS is right for you, or if other psychiatric solutions fit better.</p>
                </div>
                <div class="journey-step-card reveal delay-1">
                    <div class="journey-step-num">02</div>
                    <div class="journey-step-connector"></div>
                    <h3>Personalized Evaluation</h3>
                    <p>A comprehensive assessment to map out your specific treatment protocol and pinpoint the exact location for stimulation (motor threshold mapping).</p>
                </div>
                <div class="journey-step-card reveal delay-2">
                    <div class="journey-step-num">03</div>
                    <div class="journey-step-connector"></div>
                    <h3>TMS Sessions</h3>
                    <p>Brief, 20-30 minute daily sessions over a period of 4-6 weeks while you relax in a comfortable chair. You can return to normal activities immediately.</p>
                </div>
                <div class="journey-step-card reveal delay-3">
                    <div class="journey-step-num">04</div>
                    <div class="journey-step-connector"></div>
                    <h3>Measurable Improvement</h3>
                    <p>Track your progress with structured assessments and experience a return to your best self. Most patients notice changes within a few weeks.</p>
                </div>
            </div>
        </div>
    </section>
