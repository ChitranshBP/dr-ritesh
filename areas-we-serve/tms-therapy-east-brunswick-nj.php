<?php
$page_title = 'TMS Therapy Near East Brunswick, NJ | Dr. Ritesh Amin';
$page_desc = 'Advanced TMS therapy for mental health and neurological conditions serving East Brunswick, NJ. FDA-cleared, non-invasive brain stimulation. Call (732) 379-1797.';
        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="max-w-5xl mx-auto text-center reveal">
                ...
                <p class="text-lg text-white/75 max-w-xl mx-auto leading-relaxed mb-8">
                    Residents of East Brunswick, NJ have access to advanced, FDA-cleared Transcranial Magnetic Stimulation (TMS) therapy with Dr. Ritesh Amin. Conveniently located near East Brunswick, our practice provides personalized, non-invasive, medication-free treatment for depression, anxiety, OCD, and select neurological conditions. Our goal is to help patients achieve lasting symptom relief and improve their overall quality of life.
                </p>
        ...
        <div class="container services-container">
            <div class="services-header reveal">
                <div class="services-title-wrapper">
                    ...
                    <h2 class="section-title">TMS Services We Offer in East Brunswick, NJ</h2>
    ...
    <section class="specialties-section bg-beige-dark" id="conditions">
        <div class="container">
            <div class="section-header center reveal">
                ...
                <h2 class="section-title">Conditions We Treat in East Brunswick, NJ</h2>
        ...
        <div class="container">
            ...
            <div class="trust-grid reveal delay-1">
                ...
                <div class="trust-card">
                    ...
                    <h3>Serving East Brunswick &amp; Nearby Areas</h3>
        ...
        <div class="container tms-container">
            <div class="tms-grid header-align-start items-start">
                <div class="tms-content reveal w-full lg:max-w-4xl mx-auto col-span-1 lg:col-span-2 text-center lg:text-left">
                    ...
                    <p class="tms-para text-center lg:text-left max-w-2xl mx-auto lg:mx-0">Common questions about TMS therapy for patients in East Brunswick, NJ.</p>
