<?php
$page_title = 'TMS Therapy in Kendall Park, NJ | Dr. Ritesh Amin';
$page_desc = 'Advanced TMS therapy for mental health and neurological conditions serving Kendall Park, NJ. FDA-cleared, non-invasive brain stimulation. Call (732) 379-1797.';
        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                ...
                <p class="text-lg text-white/75 max-w-xl mx-auto leading-relaxed mb-8">
                    Dr. Ritesh Amin provides FDA-cleared Transcranial Magnetic Stimulation (TMS) therapy to patients in Kendall Park, NJ. Our advanced neuromodulation treatments offer hope for those struggling with depression, anxiety, OCD, PTSD, and a wide range of neurological conditions — all without systemic side effects or downtime.
                </p>
    ...
    <section class="specialties-section bg-beige-dark" id="conditions">
        <div class="container">
            <div class="section-header center reveal">
                ...
                <h2 class="section-title">Conditions We Treat in Kendall Park, NJ</h2>
        ...
        <div class="container tms-container">
            <div class="tms-grid header-align-start items-start">
                <div class="tms-content reveal w-full lg:max-w-4xl mx-auto col-span-1 lg:col-span-2 text-center lg:text-left">
                    ...
                    <p class="tms-para text-center lg:text-left max-w-2xl mx-auto lg:mx-0">Common questions about TMS therapy for patients in Kendall Park, NJ.</p>
