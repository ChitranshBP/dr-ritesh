<?php
$page_title = 'TMS Therapy Near Rocky Hill, NJ | Dr. Ritesh Amin';
$page_desc = 'Advanced TMS therapy for mental health and neurological conditions serving Rocky Hill, NJ. FDA-cleared, non-invasive brain stimulation. Call (732) 379-1797.';
    ...
    <section class="bihero" id="hero">
        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                <h1 class="text-4xl lg:text-5xl font-serif text-white leading-tight mb-4">TMS Therapy Near Rocky Hill, NJ</h1>
                ...
                <p class="text-lg text-white/75 max-w-xl mx-auto leading-relaxed mb-8">
                    Discover a path to wellness in Rocky Hill with Dr. Ritesh Amin's specialized TMS therapy. By delivering targeted magnetic pulses to the brain, we effectively treat medication-resistant depression and various neurological disorders in a comfortable, outpatient setting.
                </p>
        ...
        <div class="container services-container">
            <div class="services-header reveal">
                <div class="services-title-wrapper">
                    ...
                    <h2 class="section-title">TMS Services We Offer in Rocky Hill, NJ</h2>
    ...
    <section class="specialties-section bg-beige-dark" id="conditions">
        <div class="container">
            <div class="section-header center reveal">
                ...
                <h2 class="section-title">Conditions We Treat in Rocky Hill, NJ</h2>
        ...
        <div class="container">
            ...
            <div class="trust-grid reveal delay-1">
                ...
                <div class="trust-card">
                    ...
                    <h3>Serving Rocky Hill &amp; Nearby Areas</h3>
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="about-content reveal delay-1">
                    ...
                    <p>Dr. Amin serves the Rocky Hill community with a focus on comprehensive psychiatric evaluations and advanced therapeutic interventions. His dedication to clinical excellence ensures that patients facing complex mental health or neurological challenges receive the highest standard of care.</p>
                    <p>With extensive clinical experience, Dr. Amin is dedicated to providing compassionate, evidence-based care to patients in Rocky Hill and throughout central New Jersey. His personal philosophy centers around treating the whole person, not just the symptoms, ensuring each patient receives a tailored approach to their mental wellness.</p>
        ...
        <div class="container tms-container">
            <div class="tms-grid header-align-start items-start">
                <div class="tms-content reveal w-full lg:max-w-4xl mx-auto col-span-1 lg:col-span-2 text-center lg:text-left">
                    ...
                    <p class="tms-para text-center lg:text-left max-w-2xl mx-auto lg:mx-0">Common questions about TMS therapy for patients in Rocky Hill, NJ.</p>
