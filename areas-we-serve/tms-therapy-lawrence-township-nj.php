    ...
    <section class="bihero" id="hero">
        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                <span class="block font-sans text-sm font-semibold uppercase tracking-[2px] text-gold mb-4">TMS Therapy Near Lawrence Township, NJ</span>
                ...
                <p class="text-lg text-white/75 max-w-xl mx-auto leading-relaxed mb-8">
                    Dr. Ritesh Amin provides FDA-cleared Transcranial Magnetic Stimulation (TMS) therapy to patients in Lawrence Township, NJ. 
