<?php
$page_title = 'TMS Therapy Near Lawrence Township, NJ | Dr. Ritesh Amin';
$page_desc = 'Advanced TMS therapy for mental health and neurological conditions serving Lawrence Township, NJ. FDA-cleared, non-invasive brain stimulation. Call (732) 379-1797.';
    ...
    <section class="bihero" id="hero">
        ...
        <div class="container mx-auto px-4 max-w-7xl relative z-10">
            <div class="max-w-3xl mx-auto text-center reveal">
                <h1 class="text-4xl lg:text-5xl font-serif text-white leading-tight mb-4">TMS Therapy Near Lawrence Township, NJ</h1>
                ...
                <p class="text-lg text-white/75 max-w-xl mx-auto leading-relaxed mb-8">
                    Serving the Lawrence Township community, Dr. Ritesh Amin brings innovative Transcranial Magnetic Stimulation to patients battling stubborn depression, OCD, and neurological conditions. Our personalized approach ensures each treatment is uniquely tailored for maximum efficacy and comfort.
                </p>
        ...
        <div class="container services-container">
            <div class="services-header reveal">
                <div class="services-title-wrapper">
                    ...
                    <h2 class="section-title">TMS Services We Offer in Lawrence Township, NJ</h2>
    ...
    <section class="specialties-section bg-beige-dark" id="conditions">
        <div class="container">
            <div class="section-header center reveal">
                ...
                <h2 class="section-title">Conditions We Treat in Lawrence Township, NJ</h2>
        ...
        <div class="container">
            ...
            <div class="trust-grid reveal delay-1">
                ...
                <div class="trust-card">
                    ...
                    <h3>Serving Lawrence Township &amp; Nearby Areas</h3>
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="about-content reveal delay-1">
                    ...
                    <p>For individuals in Lawrence Township seeking a specialized psychiatric approach, Dr. Amin offers unparalleled expertise in Treatment-Resistant Depression. His patient-first philosophy means that your treatment plan is constantly monitored and adapted to ensure you achieve the best possible clinical outcomes.</p>
                    <p>With extensive clinical experience, Dr. Amin is dedicated to providing compassionate, evidence-based care to patients in Lawrence Township and throughout central New Jersey. His personal philosophy centers around treating the whole person, not just the symptoms, ensuring each patient receives a tailored approach to their mental wellness.</p>
        ...
        <div class="container tms-container">
            <div class="tms-grid header-align-start items-start">
                <div class="tms-content reveal w-full lg:max-w-4xl mx-auto col-span-1 lg:col-span-2 text-center lg:text-left">
                    ...
                    <p class="tms-para text-center lg:text-left max-w-2xl mx-auto lg:mx-0">Common questions about TMS therapy for patients in Lawrence Township, NJ.</p>
