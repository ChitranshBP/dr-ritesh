...
?>
    ...
    <section class="closing-cta py-16 lg:py-20 relative overflow-hidden" id="take-action">
        <div class="container mx-auto px-4 max-w-4xl text-center reveal relative z-10">
            <span class="block text-sm font-semibold tracking-widest text-gold-light uppercase mb-3">Take Action</span>
            ...
            <p class="text-sm text-white/50 mt-6">Also explore <a href="/psychiatry-tms-therapy.php" class="text-gold-light underline hover:text-white">TMS for Psychiatry</a> and <a href="/neurology-tms-therapy.php" class="text-gold-light underline hover:text-white">TMS for Neurology</a>.</p>
        </div>
    </section>
